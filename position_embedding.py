...
class PositionEncoder:
    ...
    def __post_init__(self):
        self._add_position_encodings()

    def _add_position_encodings(self) -> None:
        """Generate positional encodings for positions 0 to num_positions-1."""
        positions = np.arange(self.sequence_length).reshape(-1, 1)
        ...
        encoding = np.zeros((self.sequence_length, self.embedding_dim))
