...
class SequenceEncoder:
    ...
    def _add_token(self, token: str) -> None:
        ...
        if not token in self._token_map:
            vector = np.random.uniform(-1, 1, size = self.embedding_dim)
    ...
    def _add_position_encodings(self, sequence_length: int) -> None:
        ...
        encoding = np.zeros((sequence_length, self.embedding_dim))
    ...
    def __post_init__(self) -> None:
        ...
        self._add_position_encodings(len(self.sequence))
